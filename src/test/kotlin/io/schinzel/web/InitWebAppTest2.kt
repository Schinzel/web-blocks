...
import io.schinzel.web.test_routes2.DummyClass2
import io.schinzel.web.test_routes3.DummyClass3
import io.schinzel.web.test_routes4.DummyClass4
...
class InitWebAppTest2 {
    ...
    fun `Page named api - throes error`() {
        ...
        val webAppConfig = WebAppConfig(
            routesPackage = "io.schinzel.web.test_routes2",
            port = randomPort,
            logger = NoLogger(),
    ...
    fun `Page named static - throws error`() {
        ...
        DummyClass3()
        val webAppConfig = WebAppConfig(
            routesPackage = "io.schinzel.web.test_routes3",
            port = randomPort,
            logger = NoLogger(),
            prettyFormatHtml = false
        )
    ...
    fun `Page named page-api - throws error`() {
        ...
        DummyClass4()
        val webAppConfig = WebAppConfig(
            routesPackage = "io.schinzel.web.test_routes4",
            port = randomPort,
            logger = NoLogger(),
            prettyFormatHtml = false
        )
