...
import io.schinzel.page_elements.component.template_engine.file_reader.IFileReader2
...
class TemplateProcessor2(caller: Any) {
    private val data: MutableMap<String, String> = mutableMapOf()
    private val fileReader: IFileReader2 = FileReaderFactory.create2(caller)
